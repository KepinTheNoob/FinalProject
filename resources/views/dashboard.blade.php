...
<body>
        ...
        <div id="detail-informations">
            <div id="leader-informations">
                ...
                <div id="leader-details">
                    ...
                    <div>
                        ...
                        <span class="sub-detail">Vira Yessica</span>
                    </div>
                    <div>
                        <span class="sub-header">Place and Date of Birth</span>
                        <span class="sub-detail">Jakarta, 10 January 2005</span>
                    </div>
                    <div>
                        <span class="sub-header">Email</span>
                        <span class="sub-detail">vira.yessica@binus.ac.id</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span class="sub-detail">@virayessica</span>
                    </div>
                    <div>
                        <span class="sub-header">Github ID</span>
                        <a href="" class="sub-link">github.com/ViraYessica</a>
                    </div>
                    <div>
            ...
            <div id="participant-informations">
                ...
                <button id="edit-profile" type="submit">
                    <img src="/user/assets/Create.png" alt="logo">
    ...
    <a href="" id="back-btn">
        <img src="/user/assets/Left.png" alt="svg">
    ...
    <div id="footer">
        <div id="logo-footer">
            ...
            <img src="/user/assets/bncc-black-bg 2.png" alt="logo">
        </div>
        <div id="icons-footer">
            <a href="">
                <img src="/user/assets/hack-instagram 2.svg" alt="icon">
            </a>
            <a href="">
                <img src="/user/assets/Vector.svg" alt="icon">
            </a>
            <a href="">
                <img src="/user/assets/Mask group.svg" alt="icon">
            </a>
            <a href="">
                <img src="/user/assets/hack-facebook 2.svg" alt="icon">
            </a>
            <a href="">
                <img src="/user/assets/hack-linkedin 2.svg" alt="icon">
            </a>
        </div>
    </div>
